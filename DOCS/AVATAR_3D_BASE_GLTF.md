...
- **Pose «Estrela» vs «Guarda»** (`IllustrativeBodyAvatar`): afecta o **SVG 2D** (`Avatar`) e, se o utilizador escolher «Modelo 3D», **o mesmo GLB** (M/F conforme a ficha) na vista WebGL.
