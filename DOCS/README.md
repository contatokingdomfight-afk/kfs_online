# Documentação KFS Online (`DOCS/`)

Pasta **canónica** de documentação do repositório `kfs_online`.

| Começar por | Ficheiro |
|-------------|----------|
...
Regra do projeto: alterações de comportamento visível devem reflectir-se aqui (ver `.cursor/rules/documentacao-projeto.mdc`).
