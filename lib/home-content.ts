...
export const homeContent = {
  pt: {
    ...
    planOnlineAudience: "Sem acompanhamento de performance nem check-in de aulas presenciais.",
    planPresencial1: "Kingdom Presencial I",
    planPresencial1Price: "€50",
    planPresencial1Desc: "Uma aula por dia, uma modalidade. Performance e check-in incluídos.",
  ...
  en: {
    ...
    planOnlineAudience: "No performance tracking or in-person class check-in.",
    planPresencial1: "Kingdom Presencial I",
    planPresencial1Price: "€50",
    planPresencial1Desc: "One class per day, one modality. Performance and check-in included.",
