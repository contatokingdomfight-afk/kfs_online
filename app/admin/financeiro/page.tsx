    ...
    <div>
      ...
      <FinanceiroModals
        ...
        labels={{
          ...
          filterTypeAll: t("adminFinanceFilterTypeAll"),
          filterTypeTuition: t("adminFinanceFilterTypeTuition"),
          filterTypeInsurance: t("adminFinanceFilterTypeInsurance"),
          filterTypeEnrollment: t("adminFinanceFilterTypeEnrollment"),
