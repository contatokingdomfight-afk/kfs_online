...
import styles from "@/app/coach/alunos/[id]/AlunoTabs.module.css";
...
export function AdminAlunoTabs({ studentId }: Props) {
  ...
  const tabs = [
    ...
    { href: `${base}/contrato`, label: "Documentos de adesão" },
    ...
    { href: `${base}/editar`, label: "Editar dados" },
  ];
