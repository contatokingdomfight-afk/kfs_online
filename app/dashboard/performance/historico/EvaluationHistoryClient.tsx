              ...
              {(modalEval.gas != null || modalEval.technique != null || modalEval.strength != null || modalEval.theory != null) && (
                <div>
                  ...
                  <div className="flex flex-wrap gap-3 text-sm">
                    ...
                    {modalEval.technique != null && <span>Técnico: {modalEval.technique}</span>}
                    {modalEval.strength != null && <span>Força: {modalEval.strength}</span>}
                    {modalEval.theory != null && <span>Teórico: {modalEval.theory}</span>}
                  </div>
                </div>
              )}
            </div>
